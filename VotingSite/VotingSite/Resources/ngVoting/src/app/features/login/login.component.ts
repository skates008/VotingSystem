...
export class LoginComponent implements OnInit {
  ...
  formGroup = new FormGroup({
    ...
    LoginId: new FormControl(null, [Validators.required, Validators.minLength(8), Validators.maxLength(8), Validators.pattern("\\d+")]),
    LoginPin: new FormControl(null, [Validators.required, Validators.minLength(4), Validators.maxLength(4), Validators.pattern("\\d+")])
  });
